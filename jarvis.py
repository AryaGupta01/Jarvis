...
class Jarvis:
    ...
    def execute_query(self, query):
        ...
        if 'jarvis who made you' in query:
            ...
            try:
                os.startfile('C:/Users/archi/Downloads/J.A.R.V.I.S-master/J.A.R.V.I.S-master/song.mp3')
            ...
            if platform == "win32" or "darwin":
                speak('Arya is my master. He created me couple of days ago')
            ...
            if platform == "win32":
                os.startfile(
                    'C:/Users/archi/AppData/Local/Programs/Microsoft VS Code/Code.exe')
...
if __name__ == '__main__':
    ...
    names = ['','Arya']  #names, leave first empty bcz counter starts from 0
